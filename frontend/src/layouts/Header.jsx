...
export function Header({ onMenuClick }) {
    ...
    return (
        <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/70 px-3 md:px-6 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/70">
