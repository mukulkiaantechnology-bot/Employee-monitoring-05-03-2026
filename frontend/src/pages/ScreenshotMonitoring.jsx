        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 py-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative" ref={calendarRef}>
              ...
              >
                <Calendar size={16} className={selectedPreset === 'Today' ? "text-primary-600 dark:text-primary-400" : "text-slate-400"} />
                Today
              </button>

              {/* Calendar Dropdown */}
              {showCalendarDropdown && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in duration-200 origin-top-left">
                  <div className="p-4 border-b border-slate-200 dark:border-slate-800 bg-[#fcfdfe] dark:bg-slate-800/50">
                  ...
                  <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-[#fcfdfe] dark:bg-slate-800/50 flex justify-end">
                    <button
