...
export const activities = [
    { id: 1, employeeId: 1, employee: 'John Doe', activity: 'VS Code: indexing project', time: '10:00 AM', startTime: '10:00:00 AM', endTime: '12:15:00 PM', duration: '2h 15m', computer: 'workstation-01', app: 'Visual Studio Code', website: 'github.com' },
    { id: 2, employeeId: 2, employee: 'Jane Smith', activity: 'Chrome: Meeting with Client', time: '11:30 AM', startTime: '11:30:00 AM', endTime: '12:30:00 PM', duration: '1h 00m', computer: 'macbook-pro-2', app: 'Google Chrome', website: 'meet.google.com' },
    { id: 3, employeeId: 3, employee: 'Alex Johnson', activity: 'Figma: Design Review', time: '01:00 PM', startTime: '01:00:00 PM', endTime: '01:45:00 PM', duration: '45m', computer: 'imac-design', app: 'Figma', website: 'figma.com' },
    { id: 4, employeeId: 1, employee: 'John Doe', activity: 'VS Code: Code Refactoring', time: '02:30 PM', startTime: '02:30:00 PM', endTime: '04:00:00 PM', duration: '1h 30m', computer: 'workstation-01', app: 'Visual Studio Code', website: 'stackoverflow.com' },
    { id: 5, employeeId: 4, employee: 'Sarah Brown', activity: 'Terminal: Deploying to Production', time: '09:00 AM', startTime: '09:00:00 AM', endTime: '10:30:00 AM', duration: '1h 30m', computer: 'devops-rig', app: 'Terminal', website: 'aws.amazon.com' },
    { id: 6, employeeId: 5, employee: 'Michael Lee', activity: 'Chrome: QA Automation', time: '10:30 AM', startTime: '10:30:00 AM', endTime: '12:00:00 PM', duration: '1h 30m', computer: 'qa-tester-1', app: 'Google Chrome', website: 'jira.com' },
];
...
export const screenshots = [
    { id: 1, employeeId: 1, employee: 'John Doe', time: '10:15 AM', date: '2026-02-26', url: 'https://picsum.photos/seed/a1/800/450', isBlurred: false, productivity: 'productive', type: 'automatic', category: 'work', app: 'Visual Studio Code', project: 'Enterprise Hub', task: 'Frontend Development', team: 'Engineering', timestamp: '2026-02-26T10:15:00Z' },
    { id: 2, employeeId: 2, employee: 'Jane Smith', time: '10:30 AM', date: '2026-02-26', url: 'https://picsum.photos/seed/a2/800/450', isBlurred: true, productivity: 'neutral', type: 'automatic', category: 'review', app: 'Google Chrome', project: 'Client Portal', task: 'Design Review', team: 'Design', timestamp: '2026-02-26T10:30:00Z' },
    { id: 3, employeeId: 3, employee: 'Alex Johnson', time: '11:00 AM', date: '2026-02-26', url: 'https://picsum.photos/seed/a3/800/450', isBlurred: false, productivity: 'productive', type: 'manual', category: 'testing', app: 'Figma', project: 'Mobile App', task: 'Prototyping', team: 'Design', timestamp: '2026-02-26T11:00:00Z' },
    { id: 4, employeeId: 4, employee: 'Sarah Brown', time: '11:45 AM', date: '2026-02-26', url: 'https://picsum.photos/seed/a4/800/450', isBlurred: false, productivity: 'unproductive', type: 'automatic', category: 'work', app: 'Slack', project: 'Internal Comm', task: 'Management', team: 'Management', timestamp: '2026-02-26T11:45:00Z' },
];
...
export const teams = [
    { id: 1, name: 'Engineering', lead: 'David Wilson', members: 45, color: 'bg-blue-500' },
    { id: 2, name: 'Product', lead: 'Jane Smith', members: 12, color: 'bg-purple-500' },
    { id: 3, name: 'Design', lead: 'Alex Johnson', members: 8, color: 'bg-emerald-500' },
    { id: 4, name: 'Marketing', lead: 'James Miller', members: 15, color: 'bg-amber-500' },
];
...
export const projects = [
    ...
    { id: 4, name: 'E-commerce Integration', client: 'Retail Giant', progress: 20, status: 'On Track', color: 'bg-indigo-500' },
    { id: 5, name: 'Security Patching', client: 'Global Bank', progress: 60, status: 'Delayed', color: 'bg-rose-500' },
    { id: 6, name: 'HR Portal V2', client: 'Internal', progress: 10, status: 'Planning', color: 'bg-slate-500' },
];
